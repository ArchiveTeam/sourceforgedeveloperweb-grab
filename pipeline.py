...
TRACKER_ID = 'sourceforgedeveloperweb'
...
LUA_SHA1 = get_hash(os.path.join(CWD, 'sourceforgedeveloperweb.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--content-on-error',
            '--lua-script', 'sourceforgedeveloperweb.lua',
            ...
            '--connect-timeout', '1',
            '--tries', 'inf',
            '--domains', 'sourceforge.net,sf.net,sourceforge.io,sf.io',
            '--span-hosts',
            '--waitretry', '30',
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'path':
                user, path = item_value.split(':', 1)
                url = 'https://{}.users.sourceforge.net{}'.format(user, path)
                wget_args.extend(['--warc-header', 'sourceforge-developer-web-user: '+user])
                wget_args.extend(['--warc-header', 'sourceforge-developer-web-user-{}-path: {}'.format(user, path)])
                wget_args.extend(['--warc-header', 'sourceforge-developer-web-url: '+url])
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/e/e1/Sourceforge_icon.png" height="50px" title=""/>
        <h2>SourceForge Developer Web <span class="links"><a href="https://sourceforge.net/">Website</a> &middot; <a href="http://tracker.archiveteam.org/sourceforgedeveloperweb/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/SourceForge Developer Web">Wiki</a></span></h2>
        <p>Archiving SourceForge Developer Web.</p>
    '''
)
